 ...
 * {@link BuildingDetails.OnFragmentInteractionListener} interface
...
public class BuildingDetails extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        setMe = (TextView) getView().findViewById(R.id.set_me);
        String text = bundle.getString("passMessage");
        setMe.setText(text);
    }
